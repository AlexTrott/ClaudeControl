...
export function HowItWorks() {
  return (
    <SectionWrapper id="how-it-works" className="py-24">
      <AnimateOnScroll>
        <p className="text-accent-amber text-sm font-medium tracking-wider uppercase mb-4">
          Getting Started
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(90deg, rgba(230,113,78,0.3), rgba(230,168,78,0.3), rgba(78,184,166,0.3))",
          }}
        />
